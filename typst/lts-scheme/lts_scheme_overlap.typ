...
#let params = (
  xShift: 0.5,
  axis_xShift_scaler: 1.2,
  label_xShift: 0.5,
  every_second_full_compute_xShift: 0.075,
  fig_width: 4.2,
  fig_height: 4.3,
...
#canvas(
  length: 2.5cm,
  {
    ...
    line(
        (-0.3, 0 * params.dt_0 - 0.04),
        (-0.3, 1 * params.dt_0 + 0.04),
        stroke: params.flux_arrow_stroke,
        mark: (start: "+",end: "+"),
      )
    content((-0.3, 0.5*params.dt_0), [$Delta t$], anchor: "east", padding: 0.05)
    ...
    make_block(1, params, dt_base: (0.7, ))
    make_block(2, params, dt_base: (2.4, )) 
    make_block(3, params, dt_base: (1.1,))
